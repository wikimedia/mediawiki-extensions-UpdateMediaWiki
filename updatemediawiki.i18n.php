...
$messages[ 'es' ] = array(
        ...
        'updatemediawiki-desc' => "Permite a los administradores y usuarios autorizados actualizar MediaWiki desde una pÃ¡gina especial.",
        'updatemediawiki-current' => "VersiÃ³n Actual",
        'updatemediawiki-update-nofound' => "No hay actualizaciones disponibles",
        'updatemediawiki-update-found' => "Nueva actualizaciÃ³n encontrada",
        'updatemediawiki-update-downloading' => "Descargando nueva actualizaciÃ³n",
        'updatemediawiki-update-saved' => "Nueva actualizaciÃ³n descargada y guardada",
        'updatemediawiki-update-exist' => "La actualizaciÃ³n ya se habÃ­a descargado",
        'updatemediawiki-update-copyready' => "Copia lista",
        'updatemediawiki-update-database' => "Â¿Actualizar la base de datos ahora?",
        'updatemediawiki-update-updateready' => "ActualizaciÃ³n lista",
        'updatemediawiki-update-install' => "Â¿Instalar ahora?",
        'updatemediawiki-update-updated' => "MediaWiki actualizado a la versiÃ³n",
        'updatemediawiki-update-error' => "No se pudo obtener las Ãºltimas actualizaciones",
        'updatemediawiki-update-aborted' => "No se pudo descargar la actualizaciÃ³n. OperaciÃ³n abortada",
