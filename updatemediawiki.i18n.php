...
$messages['es'] = array(
        ...
        'updatemediawiki-desc' => "Permite a los administradores y usuarios autorizados actualizar MediaWiki desde una p�gina especial.",
        'updatemediawiki-current' => "Versi�n Actual",
        'updatemediawiki-update-nofound' => "No hay actualizaciones disponibles",
        'updatemediawiki-update-found' => "Nueva actualizaci�n encontrada",
        'updatemediawiki-update-downloading' => "Descargando nueva actualizaci�n",
        'updatemediawiki-update-saved' => "Nueva actualizaci�n descargada y guardada",
        'updatemediawiki-update-exist' => "La actualizaci�n ya se hab�a descargado",
